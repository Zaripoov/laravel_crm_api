...
class ModuleMake extends Command
{
    ...
    private function createController()
    {
        ...
        if ($this->alreadyExists($path)) {
            ...
            $stub = str_replace(
                ...
                [
                    "App\\Modules\\".str_replace('/', '\\',trim($this->argument('name')))."\\Controllers",
                    $this->laravel->getNamespace(),
                    $controller.'Controller',
                    "App\\Modules\\".str_replace('/', '\\',trim($this->argument('name')))."\\Models\\{$modelName}",
                    $modelName,
                    lcfirst(($modelName))
                ],
                $stub
    ...
    private function getControllerPathApi($argument)
    {
        $controller = Str::studly(class_basename($this->argument('name')));
