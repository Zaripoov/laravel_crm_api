...
class SourcesController extends Controller
{
    ...
    public function store(SourcesRequest $request)
    {
        ...
        return ResponseService::sendJsonResponse(true,200,[],['user' => $item->toArray()]);
    }
    ...
    public function update(SourcesRequest $request, Source $source)
    {
        ...
        return ResponseService::sendJsonResponse(true,200,[],['item' => $item->toArray()]);
    }
